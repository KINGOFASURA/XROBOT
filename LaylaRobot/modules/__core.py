from XROBOT import telethn as tbot
from XROBOT.events import register
import os
import asyncio
import os
import time
from datetime import datetime
from XROBOT import OWNER_ID, DEV_USERS
...
async def Prof(event):
    ...
    the_plugin_file = "./XROBOT/modules/{}.py".format(input_str)
