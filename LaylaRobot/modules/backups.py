...
import XROBOT.modules.sql.notes_sql as sql
from XROBOT import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from XROBOT.__main__ import DATA_IMPORT
from XROBOT.modules.helper_funcs.chat_status import user_admin
from XROBOT.modules.helper_funcs.alternate import typing_action

# from XROBOT.modules.rules import get_rules
import XROBOT.modules.sql.rules_sql as rulessql

# from XROBOT.modules.sql import warns_sql as warnssql
import XROBOT.modules.sql.blacklist_sql as blacklistsql
from XROBOT.modules.sql import disable_sql as disabledsql

# from XROBOT.modules.sql import cust_filters_sql as filtersql
# import XROBOT.modules.sql.welcome_sql as welcsql
import XROBOT.modules.sql.locks_sql as locksql
from XROBOT.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("XROBOT{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("XROBOT{}.backup".format(chat_id), "rb"),
